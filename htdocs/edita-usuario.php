...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE login SET nome = :nome, email = :email, senha = :senha WHERE id = :id";
                    ...
                    <div class="row">
                        <div class="card mb-4">
                            <div class="card-header">
                                <h3 class="card-title">EDITA USUARIO :: <?php echo $usuario["id"]." | ".$usuario["nome"];?></h3>
                            </div> <!-- /.card-header -->
                            <div class="card-body">
                            <form action="edita-usuario.php?id=<?php echo $usuario['id']?>" method="POST" class="needs-validation" novalidate>
                                    ...
                                    <div class="text-end">
                                        <button type="submit" class="btn btn-primary">Salvar</button>
                                         <!-- Botão Excluir -->
                                        <a href="exclui-usuario.php?id=<?php echo htmlspecialchars($usuario['id']); ?>" 
