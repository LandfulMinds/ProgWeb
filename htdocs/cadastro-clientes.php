...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (empty($nome) || empty($email) || empty($telefone) || empty($endereco) || empty($data_nascimento )) {
            throw new Exception("Todos os campos são obrigatórios!");
        }

        // Prepara o SQL para inserir os dados
        $sql = "INSERT INTO clientes (nome, email, telefone, endereco, data_nascimento, data_atualizacao) VALUES (:nome, :email, :telefone, :endereco, :data_nascimento, :data_atualizacao)";
        ...
        if ($stmt->execute()) {
            ...
            header("Location: edita-clientes.php?id=$lastId&msg=sucesso");
            exit;
        } else {
    ...
    // Trata erros e exibe a mensagem
                ...
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="row">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            <form action="cadastro-clientes.php" method="POST" class="needs-validation" novalidate>
                                    <!-- Campo Nome -->
                                    <div class="mb-3">
                                    ...
                                    <!--campo telefone-->
                                       ...
                                       <input type="tel" id="telefone" name="telefone" 
                                            ...
                                            required>
                                        <div class="invalid-feedback">
                                            Por favor, insira a telefone do usuário
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                       ...
                                       <input type="text" id="endereco" name="endereco" 
                                            ...
                                            required>
                                        <div class="invalid-feedback">
                                            Por favor, insira a Endereço do usuário
                                        </div>
                                    </div>
