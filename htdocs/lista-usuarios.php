    ...
    $qtd_user = count($listaUsuarios);
                        ...
                        for($i=0;$i<$qtd_user;$i++) {
                                   echo $linha = "<tr class=\"align-middle\">
                                            ...
                                            <a href=\"edita-usuario.php?id=".$listaUsuarios[$i]["id"]."\"class=\"btn btn-primary btn-sm\" title=\"editar\">
                                            <i class=\"bi bi-pencil\"></i>
                                            </a>

                                            <a href=\"exclui-usuario.php?id=".$listaUsuarios[$i]["id"]."\"class=\"btn btn-danger btn-sm\" title=\"excluir\" onclick=\"return confirm('TEM CERTEZA DE QUE DESEJA EXCLUIR ESTE USUÁRIO?');\">
