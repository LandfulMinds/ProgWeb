    ...
    $qtd_user = count($listaClientes);
                        ...
                        for($i=0;$i<$qtd_user;$i++) {
                                   echo $linha = "<tr class=\"align-middle\">
                                            ...
                                            <a href=\"edita-clientes.php?id=".$listaClientes[$i]["id"]."\"class=\"btn btn-primary btn-sm\" title=\"editar\">
                                            <i class=\"bi bi-pencil\"></i>
                                            </a>

                                            <a href=\"exclui-clientes.php?id=".$listaClientes[$i]["id"]."\"class=\"btn btn-danger btn-sm\" title=\"excluir\" onclick=\"return confirm('TEM CERTEZA DE QUE DESEJA EXCLUIR ESTE CLIENTE?');\">
