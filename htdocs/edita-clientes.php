...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE clientes SET nome = :nome, email = :email, telefone = :telefone, endereco = :endereco, data_nascimento = :data_nascimento, data_atualizacao = NOW() WHERE id = :id";
                    ...
                    <div class="row">
                        <div class="card mb-4">
                            <div class="card-header">
                                <h3 class="card-title">Editar Dados Do Cliente: <?php echo $cliente["id"]." | ".$cliente["nome"];?></h3>
                            </div> <!-- /.card-header -->
                            <div class="card-body">
                            <form action="edita-clientes.php?id=<?php echo $cliente['id']?>" method="POST" class="needs-validation" novalidate>
                                    ...
                                    <div class="mb-3">
                                       ...
                                       <input type="tel" id="telefone" name="telefone" 
                                            ...
                                            required>
                                        <div class="invalid-feedback">
                                            Por favor, insira a telefone do Cliente
                                        </div>
                                    </div>  
                                    ...
                                    <div class="mb-3">
                                       ...
                                       <input type="text" id="endereco" name="endereco" 
                                            ...
                                            required>
                                        <div class="invalid-feedback">
                                            Por favor, insira a Endereço do Cliente
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-end">
                                        <button type="submit" class="btn btn-primary">Salvar</button>
                                         <!-- Botão Excluir -->
                                        <a href="exclui-clientes.php?id=<?php echo htmlspecialchars($cliente['id']); ?>" 
