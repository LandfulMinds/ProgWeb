...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO `produtos` ( `nome`, `descricao`, `tamanho`, `categoria`, `marca`, `cor`, `preco`) VALUES ( :nome, :descricao, :tamanho, :categoria, :marca, :cor, :preco);"; 
...
if ($stmt->execute()) {
   ...
   header("location: edita-produto.php?id=$lastId&msg=sucesso");
   exit;
}
else {
    $msg = "Erro ao cadastra o produto!";
}
}
...
<!-- LOCAL PARA AJUSTARMOS O NOME -->
                ...
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="row">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            <form action="cadastro-produto.php" method="POST" class="needs-validation" novalidate>
                                    <!-- Campo Nome -->
                                    <div class="mb-3">
                                    ...
                                    <!--campo marca-->
                                        ...
                                        <input type="text-area" id="marca" name="marca" 
                                            class="form-control" 
                                            value="" 
                                            required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text-area" id="descricao" name="descricao" 
                                            class="form-control" 
                                            value="" 
                                            required>
                                        <div class="invalid-feedback">
                                    ...
                                    <!--cor-->
                                        ...
                                        <input type="text-area" id="cor" name="cor" 
                                            class="form-control" 
                                            value="" 
                                            required>
                                        <div class="invalid-feedback">
    ...
    <option value="XG" >XG</option>
                                        ...
                                        <div class="invalid-feedback">
                                            Por favor, insira o tamanho do produto.
                                        </div>
                                    <!-- Botão Salvar -->
                                    <div class="text-end">
