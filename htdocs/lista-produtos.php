...
<head>
    ...
    <title>Seu Título Aqui</title><!--begin::Primary Meta Tags-->
...
<!-- LOCAL PARA AJUSTARMOS O NOME -->
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
            <div class="sidebar-brand"> <!--begin::Brand Link--> <a href="painel.php" class="brand-link"> <!--begin::Brand Image--> <!--end::Brand Image--> <!--begin::Brand Text--> <span class="brand-text fw-light">Menu do Sistema</span> <!--end::Brand Text--> </a> <!--end::Brand Link--> </div> <!--end::Sidebar Brand--> <!--begin::Sidebar Wrapper-->
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                    <li class="nav-item"> <a href="painel.php" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>
                                    Dashboard
                                </p>
                            </a>
                        <li class="nav-item"> <a href="lista-produtos.php" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>
                                    Lista de Produtos
                                </p>
                            </a>
                            <li class="nav-item"> <a href="cadastro-produto.php" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                            <p>
                                Novo Produto
                            </p>
                        </a>
                        <li class="nav-item"> <a href="lista-usuarios.php" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                            <p>
                                Usuário
                            </p>
                        </a>
                        <li class="nav-item"> <a href="cadastro-usuario.php" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                            <p>
                                Novo Usuário 
                            </p>
                        </a>
                        </li>
                        <li class="nav-item"> <a href="lista-clientes.php" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                            <p>
                                Lista de Clientes
                            </p>
</a>
                            <li class="nav-item"> <a href="cadastro-clientes.php" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                            <p>
                                Novo Cliente
                            </p>
                        </li>
...
// Busca a lista de produtos
    ...
    $qtd_prod = count($listaProdutos);

                        for($i=0;$i<$qtd_prod;$i++) {
                                   echo $linha = "<tr class=\"align-middle\">
                                            <td>".$listaProdutos[$i]["id"]."</td>
                                            <td>".$listaProdutos[$i]["nome"]."</td>
                                            <td><span class=\"badge text-bg-primary\">".$listaProdutos[$i]["categoria"]."</span></td>
                                            <td>".$listaProdutos[$i]["cor"]."</td>
                                            <td>".$listaProdutos[$i]["tamanho"]."</td>
                                            <td>R$ ".number_format($listaProdutos[$i]["preco"],2,",",".")."</td>
                                            
                                            <td     class=\"text-center\">
                                            <a href=\"edita-produto.php?id=".$listaProdutos[$i]["id"]."\" class=\"btn btn-primary btn-sm\" title=\"Editar\">
                                            <i class=\"bi bi-pencil\"></i> 
                                            </a>
                                             <a href=\"exclui-produto.php?id=".$listaProdutos[$i]["id"]."\" class=\"btn btn-danger btn-sm\"
                                             title=\"excluir\" onclick=\"return confirm('Tem certeza de que deseja excluir este produto?');\">
